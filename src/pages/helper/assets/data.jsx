...
const infos = {
  description: [
    <>
      <h2>시작 페이지에서</h2>
      <h2>‘결제 화면 설명 보기’를 선택합니다.</h2>
    </>,
    <>
      <h2>무인결제기 설명을 보고 싶은</h2>
      <h2>업종을 선택합니다.</h2>
    </>,
    <>
      <h2>화면에 나오는 대로 동작을 진행하고,</h2>
      <h2>‘시작하기’ 버튼을 누릅니다.</h2>
    </>,
    <>
      <h2>무인결제기 사용 과정이 단계별로 나옵니다.</h2>
      <h2>하단의 버튼을 통해 이전/다음 단계로 이동합니다.</h2>
    </>,
    <>
      <h2>버튼을 누르면 해당 버튼의 기능을 알려주는</h2>
      <h2>팝업이 뜹니다. 다시 한 번 눌러 팝업을 닫습니다.</h2>
    </>,
    <>
      <h2>설명 보기를 마친 후, 다른 업종의 설명을 보거나</h2>
      <h2>실습에 도전해 실제 주문을 연습할 수 있습니다.</h2>
    </>,
  ],
  practice: [
    <>
      <h2>시작 페이지에서</h2>
      <h2>‘무인결제기 실습하기’를 선택합니다.</h2>
    </>,
    <>
      <h2>무인 결제를 실습하고 싶은</h2>
      <h2>업종을 선택합니다.</h2>
    </>,
    <>
      <h2>화면에 나오는 대로 동작을 진행하고,</h2>
      <h2>문제 확인 후에 ‘시작하기’ 버튼을 누릅니다.</h2>
    </>,
    <>
      <h2>문제대로 주문을 진행해주세요. 하단의 버튼들을</h2>
      <h2>선택하면 그에 맞는 동작을 실행합니다.</h2>
    </>,
    <>
      <h2>하단의 ‘문제보기’ 버튼을 눌러 문제를 다시 봅니다.</h2>
      <h2>문제가 어려우면 카카오톡으로 도움을 요청합니다.</h2>
    </>,
    <>
      <h2>성공적으로 주문을 완료한 경우</h2>
      <h2>해당 페이지가 뜨며 실습이 종료됩니다.</h2>
    </>,
  ],
  word: [
    <>
      <h2>시작 페이지에서</h2>
      <h2>‘무인결제기 단어장’을 선택합니다.</h2>
    </>,
    <>
      <h2>업종별로 자주 사용하는 단어를</h2>
      <h2>카테고리별로 정리하여 제공합니다.</h2>
    </>,
    <>
      <h2>궁금하거나 헷갈리는 단어를</h2>
      <h2>상단의 검색 기능으로 찾아봅니다.</h2>
    </>,
    <>
      <h2>화면을 위아래로 스크롤하여</h2>
      <h2>더욱 많은 단어와 의미를 확인할 수 있습니다.</h2>
    </>,
  ],
};
